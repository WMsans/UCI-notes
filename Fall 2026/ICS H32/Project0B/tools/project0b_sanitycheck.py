...
class TextProcess:
    ...
    def read_line(self, timeout: float | None = None) -> tuple[str, bool] | None:
...
def start_process() -> TextProcess:
    ...
    filenames_in_dir = [p.name for p in list(src_dir_path.iterdir()) if p.is_file()]
